...
gray_level_imgs=[1115, 10676, 20239, 30275, 33489, 35239, 48096, 48122, 51961]
take_out_images = idx_with_no_annotations + gray_level_imgs
...
class ModanetDataset(Dataset):
    ...
    def __getitem__(self, index):    
        while index in take_out_images: 
        ...
        for i in range(num_objs):
            ...
            # boxes.append(anns[i]['bbox']) # seems there is a problem in modanet, in boxes 
